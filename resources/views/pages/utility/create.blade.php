@extends('layouts.admindek', ['pageSlug' => 'utilities-create'])
...
@section('breadcrumbs')
    @php
        ...
        $breadcrumb_title = config('pms.breadcrumbs.utility.utility-create.title');
        $breadcrumb_subtitle = config('pms.breadcrumbs.utility.utility-create.subtitle');
    @endphp
    {{ Breadcrumbs::render('utility-create', $property) }}
@endsection
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <select class="select2" name="type" style="width: 100%">
                                    ...
                                    @foreach($utility_types as $ut)
                                        <option value="{{ $ut->type }}">{{ $ut->type }}</option>
                                    @endforeach
                                </select>
                                @error('type')
                                    <span class="messages">
