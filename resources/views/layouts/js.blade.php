...
<script type="text/javascript" src="{{ asset('laravel-admindek/bower_components/popper.js/js/popper.min.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('laravel-admindek/assets/js/vertical/vertical-layout.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('laravel-admindek/assets/js/script.min.js') }}"></script>